...
The latest published release is **[v0.8.5](../../releases/tag/v0.8.5)**. It allows recording a new app-audio session while the previous batch is being transcribed or diarized.
